 ...
 * If end host status changes such as user cancels operation or transfer is done, connectivity issue, we might want to notify related agent == agent communication handlers so they can
