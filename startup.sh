...
tmux split-window -h -p 70 -d -t sos:floodlight 'cd ../SOSForFloodlight/  && java -jar target/floodlight.jar'
tmux split-window -p 30 -d -t sos:floodlight  'cd ../SOSForFloodlight/  && bash'
